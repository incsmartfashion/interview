...
class _HomePageState extends State<HomePage> {
  ...
  void verify(BuildContext cntext) {
    print("yayayayayayayayayayyayayayayayayaay");
        ...
        Container(
          ...
          child: Center(
            ...
            child: Column(
              children: <Widget>[
                TextField(
                  decoration: InputDecoration(labelText: 'enter email to receive OTP'),
                ...
                (submitValid)
                    ? TextField(
                        decoration: InputDecoration(labelText: 'write OTP received via email'),
